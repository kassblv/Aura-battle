...
`UNAUTHORIZED`, `CLIENT_OUTDATED`, `NOT_IN_MATCH`, `WRONG_PHASE`, `DEADLINE_PASSED`, `INVALID_PAYLOAD`, `NOT_ENOUGH_ENERGY`, `ULT_NOT_READY`, `ALREADY_LOCKED`, `COSMETIC_NOT_OWNED`, `RATE_LIMITED`, `INVITE_NOT_FOUND`, `INVITE_EXPIRED`, `ALREADY_IN_QUEUE`.
