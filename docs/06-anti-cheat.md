...
- **Limite de débit par IP des routes publiques d'authentification** : `/auth/device` et `/auth/refresh` 60, `/auth/recovery/claim` 20 par quart d'heure et par seau d'IP ; désactivable hors production seulement.
